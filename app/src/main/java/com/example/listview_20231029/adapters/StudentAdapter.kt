...
class StudentAdapter(
    mContext: Context,
    resId: Int,
    val mList: ArrayList<studentData>  // getView "함수" 에서도 사용 하고 싶다 : val 키워드 추가 => 멤버변수로 등록
...
//    완성한 inf를 이용해서 => xml을 가져와주는 함수
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        // tempRow 역할 : 리스트뷰의 재사용성에서 나오는 null 가능성을 대비하기 위한 임시 변수.
...
//        Adapter에서는 데이터 바인딩 사용 불가 => 직접 코드로 불러내야 함. (텍스트뷰들 가져오기)
        ...
        val txtPhoneNum = row.findViewById<TextView>(R.id.txtPhoneNumber)
